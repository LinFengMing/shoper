		...
		<div class="ui grid">
			<div class="sixteen wide column">
				<h2 class="ui dividing header">
					...
					<div class="content">
						分類設置
						<div class="sub header">此處可以針對分類進行新增修改刪除。</div>
					</div>
				</h2>
				<div class="ui form tableForm">
					<a href="console/category/insert" class="ui tiny blue button spBtn btnInsert">
						新增
					</a>
					<div class="field">
						<table class="ui celled padded table">
							...
							<tbody>
								...
								<tr class="middle center aligned">
									...
									<td><?=$value['type'];?></td>
									<td>
										<a href="console/category/update/<?=$value['id'];?>" class="ui tiny green button spBtn">更新</a>
