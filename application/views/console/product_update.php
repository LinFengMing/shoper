				...
				<form class="ui form tableForm" method="post" enctype="multipart/form-data">
					<div class="ui grid">
						<div class="twelve wide column">
							...
							<div class="field">
								<div class="trumbowyg-content" id="trumbowyg-content">
									<?php
						...
						<div class="four wide column">
							<div class="ui padded segment main_photo_spec">
								<h4 class="ui dividing header">主要圖片</h4>
							...
							<div class="ui padded segment sub_photo_spec">
								<h4 class="ui dividing header">副圖片</h4>
								<div class="field photoImage">
								...
								<div class="field">
									<input type="file" name="sub_photo_file" class="sub_photo_file">
...
<script>
	...
	function mainPhotoButtonEvent() {
		...
		$('.main_photo_file').change(function(e) {
			var that = $(this);
			...
			var api = 'api_console/upload_main_photo';
			...
			$.ajax({
				...
				success: function(response) {
					...
					if(response.sys_code == 200) {
						that.closest('.main_photo_spec').find('.photoImage').empty();
						that.closest('.main_photo_spec').find('.photoImage').append(
							'<img src="'+response.link+'" alt="Main Photo" class="ui tiny image main_photo_img">'
							);
					}
				}
			});
